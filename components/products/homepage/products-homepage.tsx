        ...
        <div className="bg-transparent p-4 md:p-8 rounded-xl shadow-2xl overflow-hidden">
          <div className="overflow-x-hidden">
            <Tabs defaultValue="all" onValueChange={setActiveTab}>
              <TabsList className="bg-transparent p-1 rounded-full border border-zinc-700 flex items-center justify-center md:justify-center space-x-1 overflow-x-hidden  w-full max-w-full">
                {tabs.map((tab) => (
                  <TabsTrigger
                    key={tab.id}
                    value={tab.id}
