  ...
  return (
    <main className="min-h-screen bg-dark-900 relative">
      ...
      <div className="relative z-10 pt-20 md:pt-24 pb-8">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-100 mb-4">ALL PRODUCTS</h2>
            <p className="text-gray-400 text-lg md:text-xl tracking-wide mb-6">WHERE STREET MEETS ROCK</p>
            <RockSoundWave />
          </div>
        </div>
      </div>
      ...
      <section className="relative z-10 pb-12 md:pb-16">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <h3 className="text-2xl md:text-3xl font-bold text-gray-100 mb-6 md:mb-8 text-center">Shop by Category</h3>
                ...
                <Card className="bg-dark-800 border-dark-600 overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:border-gray-500 group cursor-pointer">
                  <div className="relative aspect-video">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-4">
                      <h4 className="text-xl md:text-2xl font-bold text-white mb-2">{category.name.toUpperCase()}</h4>
      ...
      <section className="relative z-10 pb-12 md:pb-24">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <h3 className="text-2xl md:text-3xl font-bold text-gray-100 mb-6 md:mb-8 text-center">All Products</h3>
